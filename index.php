...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 689;
        $headers['auth']['clientCompany'] = "kYcCT6EXWy0U8MkrZE2A";
        $headers['auth']['clientSecret'] = "Njg5a1ljQ1Q2RVhXeTBVOE1rclpFMkFjZTY2ZjZlNmY5ZGVmNTEwYWM0MGJhMmU2NWMyYWNkYTAxNDJmZmFl";
